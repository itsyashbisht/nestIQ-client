      ...
      <div className="flex flex-col gap-4">
        ...
        <Field label="Favourite Destinations">
          <Input
            ...
            placeholder="Goa, Rajasthan, Kerala"
          />
        </Field>
        <div>
          <div className="text-[10px] font-medium uppercase tracking-[0.5px] text-[#a1a4a5] mb-3">
            Travel Vibes
          </div>
        ...
        {user?.role === "Owner" || user?.role === "Admin" ? (
          <div>
            <div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-[rgba(17,255,153,0.06)] border border-[rgba(17,255,153,0.2)] mb-5">
              ...
              <span className="text-[13px] text-[#11ff99]">
          ...
          <div>
            <p className="text-[13px] text-[#a1a4a5] leading-relaxed mb-5">
              List your property on NestIQ and reach thousands of travellers.
              Upgrade your account to Owner role to access the hotel management
              dashboard.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Revenue, occupancy, and booking trends",
                },
                {
                  icon: "🏨",
                  title: "Hotel Management",
                  desc: "Add rooms, update amenities, manage images",
                },
                {
                  icon: "💰",
                  title: "Payment Tracking",
                  desc: "View all bookings and payouts",
                },
              ].map((f) => (
                <div
                  key={f.title}
                  className="p-4 rounded-xl border border-[rgba(214,235,253,0.19)] bg-[rgba(255,255,255,0.01)]"
                >
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        >
          <motion.div
            ...
            style={{
              background: "#ff801f",
              border: "2px solid rgba(255,128,31,0.3)",
            }}
          >
            {initials}
          </motion.div>
