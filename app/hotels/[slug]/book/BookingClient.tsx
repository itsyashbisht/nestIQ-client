...
export function BookingClient() {
  ...
  const isReady = Boolean(currentBooking && keyStatus === "succeeded");
      ...
      >
        <div className="text-center max-w-md">
          <motion.div
            ...
            style={{
              background: "rgba(17,255,153,0.15)",
              border: "2px solid rgba(17,255,153,0.4)",
            }}
          >
          ...
          >
            ...
            <div className="text-[11px] text-[#11ff99]">
              ...
              <div key={s} className="flex items-center flex-1">
                <div className="flex items-center gap-2 flex-shrink-0">
                  <motion.div
                    ...
                    style={{
                      color:
                        i < step ? "#000" : i === step ? "#f0f0f0" : "#464a4d",
                    }}
                  >
                    {i < step ? <Check size={12} /> : i + 1}
                  </motion.div>
                  <span
                    className={`text-[12px] font-medium ${i <= step ? "text-[#f0f0f0]" : "text-[#464a4d]"}`}
                  >
                    {s}
                  </span>
                </div>
                {i < STEPS.length - 1 && (
                  <div
                    ...
                    style={{
                      background:
                        i < step ? "#ff801f" : "rgba(214,235,253,0.19)",
                    }}
                  />
                )}
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_260px] gap-6">
                ...
                >
                  <div className="rounded-2xl border border-[rgba(214,235,253,0.19)] p-6 bg-[rgba(255,255,255,0.01)]">
                    ...
                    <div className="rounded-xl border border-[rgba(214,235,253,0.19)] p-4 mb-5">
                      ...
                      <div className="text-[11px] text-[#464a4d]">
                        Amount in INR · No hidden fees
                      </div>
                    </div>
            ...
            <div className="rounded-2xl border border-[rgba(214,235,253,0.19)] p-5 bg-[rgba(255,255,255,0.01)] h-fit sticky top-20">
              ...
              <div className="flex items-center gap-3 mb-4 pb-4 border-b border-[rgba(214,235,253,0.19)]">
                <div className="w-14 h-14 rounded-lg bg-[#0d0d0d] flex items-center justify-center text-2xl flex-shrink-0">
                  🌊
                </div>
                <div>
              ...
              <div className="flex flex-col gap-2.5 text-[12px]">
                ...
                <div className="flex justify-between text-[#a1a4a5]">
                  <span>Guests</span>
                  <span className="text-white">{guestsParam}</span>
                </div>
              ...
              <div className="mt-4 px-3 py-2.5 rounded-lg bg-[rgba(17,255,153,0.06)] border border-[rgba(17,255,153,0.15)]">
                ...
                <div className="text-[10px] text-[#a1a4a5] mt-0.5">
                  Cancel 48h before for full refund
                </div>
              </div>
            </div>
          </div>
